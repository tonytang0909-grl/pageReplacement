...
public class Memsim {
    public static void main(String[] args) {
        ...
        else if (args[2].equals("lfu"))
            mmu = new LFUMMU(frames);
        else if (args[2].equals("arc"))
            mmu = new ARCMMU(frames);
        else {
            System.out.println("Usage: java Memsim inputfile numberframes replacementmode debugmode");
        ...
        System.out.printf("page fault rate: %.4f\n", ((double) mmu.getTotalPageFaults())/no_events);
        System.out.println("total page hits: " + mmu.getPageHits());
        System.out.println("hit rate: " + ((double) mmu.getPageHits())/no_events);
